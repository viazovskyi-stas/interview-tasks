...
var StyledComponentsError = function (_Error) {
  ...
  function StyledComponentsError(code) {
    ...
    if (process.env.NODE_ENV === 'production') {
      var _this = possibleConstructorReturn(this, (StyledComponentsError.__proto__ || Object.getPrototypeOf(StyledComponentsError)).call(this, 'An error occurred. See https://github.com/styled-components/styled-components/blob/master/src/utils/errors.md#' + code + ' for more information. ' + (interpolations ? 'Additional arguments: ' + interpolations.join(', ') : '')));
    } else {
      var _this = possibleConstructorReturn(this, (StyledComponentsError.__proto__ || Object.getPrototypeOf(StyledComponentsError)).call(this, format.apply(undefined, [ERRORS[code]].concat(interpolations))));
    }
...
var flatten = function flatten(chunks, executionContext) {
  return chunks.reduce(function (ruleSet, chunk) {
    ...
    if (Array.isArray(chunk)) {
      ruleSet.push.apply(ruleSet, toConsumableArray(flatten(chunk, executionContext)));
      return ruleSet;
    }
    ...
    if (typeof chunk === 'function') {
      if (executionContext) {
        ...
        ruleSet.push.apply(ruleSet, toConsumableArray(flatten([nextChunk], executionContext)));
...
var contextShape = (_contextShape = {}, defineProperty(_contextShape, CHANNEL, PropTypes.func), defineProperty(_contextShape, CHANNEL_NEXT, CONTEXT_CHANNEL_SHAPE), _contextShape);
...
var withTheme = (function (Component$$1) {
  ...
  var WithTheme = function (_React$Component) {
    ...
    function WithTheme() {
      ...
      return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = WithTheme.__proto__ || Object.getPrototypeOf(WithTheme)).call.apply(_ref, [this].concat(args))), _this), _this.state = EMPTY_OBJECT, _this.unsubscribeId = -1, _temp), possibleConstructorReturn(_this, _ret);
    }
